...
def main() -> int:
    ...
    (project_dir / "_stage2").mkdir(parents=True, exist_ok=True)
    (project_dir / "_stage3b" / "papers").mkdir(parents=True, exist_ok=True)
    (project_dir / "_stage3c" / "papers_md").mkdir(parents=True, exist_ok=True)
